package com.technolyst.zoomintegration
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initializeSdk(context: Context) {
        ...
        val params = ZoomSDKInitParams().apply {
            appKey = "3ZUr1uVIaDuPU0CrmLNCYWVprcJtgPYJFjxX" // TODO: Retrieve your SDK key and enter it here
            appSecret = "QXVRsAQXLH2J8EE6jQrSrXztoN7y0iboDHgC" // TODO: Retrieve your SDK secret and enter it here
            domain = "zoom.us"
    ...
    private fun initViews() {
        findViewById<View>(R.id.join_button).setOnClickListener {
    ...
    private fun joinMeeting(context: Context, meetingNumber: String, pw: String) {
        ...
        val params = JoinMeetingParams().apply {
            displayName = "Prashant " // TODO: Enter your name
